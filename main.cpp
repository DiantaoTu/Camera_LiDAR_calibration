...
{
    string lidar_data_path = "/home/tdt/Data_tdt/SenseCar-Gen-2-sync/lidar-1";
    string image_data_path = "/home/tdt/Data_tdt/SenseCar-Gen-2-sync/images";
    string edge_image_path = "/home/tdt/Data_tdt/SenseCar-Gen-2-sync/edge_images/";
    string log_path = "./log/";
    SetLog(log_path);

    const int max_iteration = 30;
    const float probability = 0.8;
    const float rotation_step = 0.002;        // 以角度为单位
    const float translation_step = 0.01;    // 以米为单位
    ...
    IterateFiles(image_data_path, image_names, ".jpg");
    ...
    {
        K <<  2051.3203102806, 0, 963.8484265363,
              0, 2051.3203102806, 590.155189821,
              0, 0, 1;
        T_cl << 0.00470239, -0.99998744, -0.00173499,  0.297776 ,
                0.0025896 ,  0.00174718, -0.99999512, -0.317094,
                0.99998559,  0.00469788,  0.00259778, -0.509181 ,
                0, 0, 0, 1;
    }
    ...
    LOG(INFO) << "calibration error between ground truth and current ";
    CalibrationError(T_cl, T_cl_init);
    ...
    // 标定
    Calibrate calib(frames, lidars, 52, max_iteration, probability, rotation_step, translation_step);
